...
def check_deployment(distance, weather, robots):
...
def print_result(robots, unsafe):
...
robots = get_weights(robots)
weather = get_weather()

print()

unsafe = check_deployment(distance, weather, robots)
print_result(robots, unsafe)